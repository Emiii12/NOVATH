...
<head>
    ...
    <main>
        <h1 class="titulo-pagina text-center">USUARIOS</h1>
        <div class="container">
            <div class="row">
                    ...
                    <table class="table">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="fila-tabla" scope="col">Descuento Acumulativo</th>
                                <th class="fila-tabla" scope="col">Suspensión</th>
                            ...
                            <tr>
                                ...
                                <td class="filas-siguientes text-center">
                                    <form method="POST">
                                        ...
                                        <input type="submit" name="accion" value="Suspender" class="boton-card-eventos btn btn-outline-dark">
                                    </form>
                                </td>
                            </tr>
                        </tbody>
